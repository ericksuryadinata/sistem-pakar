...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 17, 2021 at 10:40 AM
...
('G02', 'Printer Ink Jet'),
('G03', 'Printer bermasalah pada cetakan'),
('G04', 'Hasil cetakan printer bergaris'),
('G05', 'Kertas berjalan tetapi tidak ada hasil cetakan'),
('G06', 'Hasil cetakan tidak rata'),
('G07', 'Printer tidak dapat mencetak'),
('G08', 'Printer bermasalah pada kertas'),
('G09', 'Printer tidak dapat menarik kertas'),
('G10', 'Kertas pada printer macet'),
('G11', 'Printer bermasalah pada lampu'),
('G12', 'Lampu error kedap kedip'),
('G13', 'Lampu feed dan error menyala namun printer tidak dapat mencetak');
...
(15, '11', 'Intan Vini Annisa', '085789667838', 'Printer Laser Jet', 'Mengganti tinta, toner atau pita printer dengan yg baru. Jangan lupa untuk memeriksa apakah ada sesuatu yg menghalangi head dengan kertas.', '2021-07-14'),
(16, '11', 'Intan Vini Annisa', '085789667838', 'Printer bermasalah pada cetakan', 'Mengganti tinta, toner atau pita printer dengan yg baru. Jangan lupa untuk memeriksa apakah ada sesuatu yg menghalangi head dengan kertas.', '2021-07-14'),
(17, '11', 'Intan Vini Annisa', '085789667838', 'Kertas berjalan tetapi tidak ada hasil cetakan', 'Mengganti tinta, toner atau pita printer dengan yg baru. Jangan lupa untuk memeriksa apakah ada sesuatu yg menghalangi head dengan kertas.', '2021-07-14'),
(18, '12', 'Alex', '089755557777', 'Printer Laser Jet', 'Periksa apakah pintu printer telah ditutup dengan benar. Periksa catridge, kertas dan cobalah untuk mematikan printer beberapa saat dan kemudian menghidupkan kembali', '2021-07-14'),
(19, '12', 'Alex', '089755557777', 'Printer bermasalah pada lampu', 'Periksa apakah pintu printer telah ditutup dengan benar. Periksa catridge, kertas dan cobalah untuk mematikan printer beberapa saat dan kemudian menghidupkan kembali', '2021-07-14'),
(20, '12', 'Alex', '089755557777', 'Lampu error kedap kedip', 'Periksa apakah pintu printer telah ditutup dengan benar. Periksa catridge, kertas dan cobalah untuk mematikan printer beberapa saat dan kemudian menghidupkan kembali', '2021-07-14');
...
('S01', 'Lepas cartridge dengan hati-hati untuk mengecek apakah tinta sudah habis atau belum. Setelah itu lakukan pembersihan pada mat head nya dengan menggunakan cairan pembersih tinta.'),
('S02', 'Membatasi tebal tumpukan kertas sesuai dengan kapasitas yang didukung oleh printer. Sebelum dipasang pada paper try, sebaiknya kertas dikibas-kibaskan terlebih dahulu agar kertas tidak saling menempel'),
('S03', 'Mengganti tinta, toner atau pita printer dengan yg baru. Jangan lupa untuk memeriksa apakah ada sesuatu yg menghalangi head dengan kertas.'),
('S04', 'Usaplah drum dengan kain halus untuk menghilangkan benda asing yang menempel atau dengan mengganti drum jika terdapat lubang kecil pada permukaan drum'),
('S05', 'Pastikan posisi kertas terpasang dengan baik, apabila sudah dilakukan tetapi lampu masih menyala kemungkinan sensor kertas printer rusak. Disarankan untuk mengganti sensor printer yan baru'),
('S06', 'Periksa apakah pintu printer telah ditutup dengan benar. Periksa catridge, kertas dan cobalah untuk mematikan printer beberapa saat dan kemudian menghidupkan kembali'),
('S07', 'Pengetesan printer menggunakan print test page pada driver printer.'),
('S08', 'Pengamplasan dengan hati-hati pada bagian roda penariknya. Bersihkan juga roda penggerak dari kotoran yang ada.kemungkinan lain yang bisa terjadi adalah karena tinta yang hampir habis.');
...
--
ALTER TABLE `tb_jawaban`
  MODIFY `id_jwb` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `tb_jawaban_gejala`
--
ALTER TABLE `tb_jawaban_gejala`
  MODIFY `id_jawaban_gejala` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
