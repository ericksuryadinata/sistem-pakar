    ...
    <main class="batas-atas">
        <div class="card text-white bg-info mb-3">
          ...
          <div class="card-body text-center ukuran-30">
            ...
            <form method="post" action="pakar-masukan.php" enctype="multipart/form-data" role="form">
                ...
                $arr = [];
                session_start();
                if (isset($_SESSION['answ']['m1'])) {
                    echo $_SESSION['answ']['m1'];
                }else{
                    // echo "disini";
                }
                echo "<p>Halo, ".$_SESSION['nama']."</p>";
